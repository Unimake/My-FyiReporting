            ...
            try
            {
                switch(tc)
                {
                    case TypeCode.DateTime:
                        return ((DateTime)left).CompareTo(Unimake.Convert.ToDateTime(right));
                    case TypeCode.Int16:
                        return ((short)left).CompareTo(Unimake.Convert.ToInt16(right));
                    case TypeCode.UInt16:
                        return ((ushort)left).CompareTo(Unimake.Convert.ToUInt16(right));
                    case TypeCode.Int32:
                        return ((int)left).CompareTo(Unimake.Convert.ToInt32(right));
                    case TypeCode.UInt32:
                        return ((uint)left).CompareTo(Unimake.Convert.ToUInt32(right));
                    case TypeCode.Int64:
                        return ((long)left).CompareTo(Unimake.Convert.ToInt64(right));
                    case TypeCode.UInt64:
                        return ((ulong)left).CompareTo(Unimake.Convert.ToUInt64(right));
                    case TypeCode.String:
                        return ((string)left).CompareTo(Unimake.Convert.ToString(right));
                    case TypeCode.Decimal:
                        return ((Decimal)left).CompareTo(Unimake.Convert.ToDecimal(right));
                    case TypeCode.Single:
                        return ((float)left).CompareTo(Unimake.Convert.ToSingle(right));
                    case TypeCode.Double:
                        return ((double)left).CompareTo(Unimake.Convert.ToDouble(right));
                    case TypeCode.Boolean:
                        return ((bool)left).CompareTo(Unimake.Convert.ToBoolean(right));
                    case TypeCode.Char:
                        return ((char)left).CompareTo(Unimake.Convert.ToChar(right));
                    case TypeCode.SByte:
                        return ((sbyte)left).CompareTo(Unimake.Convert.ToSByte(right));
                    case TypeCode.Byte:
                        return ((byte)left).CompareTo(Unimake.Convert.ToByte(right));
                    case TypeCode.Empty:
